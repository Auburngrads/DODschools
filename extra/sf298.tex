...
\textField[\Ff{\FfMultiline}\TU{ }\V{$if(distro_state)$$distro_state$$endif$$if(distro_rason)$; $distro_reason$$endif$ (1 January 2016). $if(distro_extra)$$distro_extra$$endif$ the RELEASING ORGANIZATION, ORG ADDRESS}]{sf12}{\textwidth}{1.2cm}
}\bigstrut\\\hline
...
\textField[\textSize{10}\TU{ }\V{$if(advisor.phone)$$advisor.phone$$else$(937) 255-3636 x0000$endif$; $if(advisor.email)$$advisor.email$$else$email@afit.edu}]{sf19b}{.4\textwidth}{0.4cm}}} \\
& & & & & \\
& & & & & \\ \cline{1-6}
\end{tabular}}
\end{document}
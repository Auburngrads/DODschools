...
- equations
- code chunks
- `r Citep(knitcitations)`
- `r citep(refmanager)`
- `r citet(knitcitations)`
...
There are many advantages to building your thesis in Rmarkdown, this paper advantage of.
...
Published articles have a [Digital Object Identifier](http://www.doi.org/), or doi associated with them.  The `knitcitations` [`r Cite(knitcitations, .opts = list(style='citation'))`] package allows us to easily cite papers by simply providing the doi.  __Note: This requires an internet connection__ 

Published articles have a [Digital Object Identifier](http://www.doi.org/), or doi associated with them.  The `knitcitations` [`r Cite(knitcitations, .opts = list(style='textVersion'))`] package allows us to easily cite papers by simply providing the doi.  __Note: This requires an internet connection__

Published articles have a [Digital Object Identifier](http://www.doi.org/), or doi associated with them.  The `knitcitations` [`r citep(knitcitations)`] package allows us to easily cite papers by simply providing the doi.  __Note: This requires an internet connection__

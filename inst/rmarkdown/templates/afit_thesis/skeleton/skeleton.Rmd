---
title:        "`r noTouch('metadata.yml')$document$title`"
designator:   "`r noTouch('metadata.yml')$document$designator`"
doctype:      "`r noTouch('metadata.yml')$document$type`"
pages:        "`r noTouch('metadata.yml')$document$pages`"
abstract:     "`r noTouch('metadata.yml')$abstract`"
dedication:   "`r noTouch('metadata.yml')$dedication`"
acknowledge:  "`r noTouch('metadata.yml')$acknowledgement`"
vita:         "`r noTouch('metadata.yml')$vita`"
degree:       "`r noTouch('metadata.yml')$degree`"
program:      "`r noTouch('metadata.yml')$program`"
distro1:      "`r noTouch('metadata.yml')$distro_thesis[1]`"
distro2:      "`r noTouch('metadata.yml')$distro_thesis[2]`"
author:
  name:       "`r noTouch('metadata.yml')$author$fullname`"
  dept:       "`r noTouch('metadata.yml')$author$dept`"
  rank:       "`r noTouch('metadata.yml')$author$rank`"
  service:    "`r noTouch('metadata.yml')$author$service`"
  prevdegree: "`r noTouch('metadata.yml')$author$currentDegree`"
  email:      "`r noTouch('metadata.yml')$author$email`"
advisor:
  name:       "`r noTouch('metadata.yml')$advisor$name`"
  department: "`r noTouch('metadata.yml')$advisor$department`"
  rank:       "`r noTouch('metadata.yml')$advisor$rank`"
  service:    "`r noTouch('metadata.yml')$advisor$service`"
  degree:     "`r noTouch('metadata.yml')$advisor$currentDegree`"
  phone:      "`r noTouch('metadata.yml')$advisor$phone`"
  email:      "`r noTouch('metadata.yml')$advisor$email`"
reader1:
...
reader3:
  ...
  service: 'usaf' # Use abbreviation - leave blank if NA
  prevdegree: 'BS, MS'
sf298name:    "`r noTouch('metadata.yml')$author$sf298name`"
contractnum:  "`r noTouch('metadata.yml')$sf298$contractnum`"
grantnum:     "`r noTouch('metadata.yml')$sf298$grantnum`"
prognum:      "`r noTouch('metadata.yml')$sf298$programnum`"
projnum:      "`r noTouch('metadata.yml')$sf298$projectnum`"
tasknum:      "`r noTouch('metadata.yml')$sf298$tasknum`"
worknum:      "`r noTouch('metadata.yml')$sf298$workunitnum`"
keywords:     "`r noTouch('metadata.yml')$sf298$keywords`"
sponsor:
  title:    "`r noTouch('metadata.yml')$sf298$sponsor$title`"
  subtitle: "`r noTouch('metadata.yml')$sf298$sponsor$subtitle`"
  address1: "`r noTouch('metadata.yml')$sf298$sponsor$address1`"
  address2: "`r noTouch('metadata.yml')$sf298$sponsor$address2`"
  phone:    "`r noTouch('metadata.yml')$sf298$sponsor$phone`"
  email1:   "`r noTouch('metadata.yml')$sf298$sponsor$email1`"
  email2:   "`r noTouch('metadata.yml')$sf298$sponsor$email2`"
  acronym:  "`r noTouch('metadata.yml')$sf298$sponsor$acronym`"
  rptnum:   "`r noTouch('metadata.yml')$sf298$sponsor$report_number`"
graddate:   "`r noTouch('metadata.yml')$grad_date`"
date:       "`r format(Sys.Date(), '%B %Y')`"
sf298_date: "`r format(Sys.Date(), '%d-%m-%Y')`"
dissertation: "`r noTouch('metadata.yml')$dissertation`"
output: 
  AFIT::afit_thesis:
    includes:

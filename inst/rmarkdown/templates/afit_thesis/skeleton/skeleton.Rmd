...
- For Windows, install [__MiKTeX__](https://miktex.org/howto/install-miktex)
- For Mac, install [__MacTeX__](https://www.tug.org/mactex/)
- For Linux, isntall [__TeX Live__](https://tug.org/texlive/)
...
If this returns a path to pandoc.exe - you're good.  If not, go [__here__](http://www.pandoc.org/installing.html) to install Pandoc for your OS.
